...
ml_output1 <- ml_output1[, c("Chrom", "Window", "Site1_Position", "Site1_SNP", "Site1_MAF", "Site1_Allele0", "Site1_Allele1",
                              ...
                              "r_10", "r_1x", "r_x0","D_10", "D_1x","D_x0","s_v_int","ML_v_int","s_v_site1","ML_v_site1", "s_v_site0", "ML_v_site0",
...
#Output
write.table(ml_output1, paste0(opt$output, ".v.maxl"), row.names = FALSE, sep="\t")